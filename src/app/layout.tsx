...
export const metadata: Metadata = {
  title: "StaffToday.AI - AI Recruitment Agency for Australian Construction",
  description: "The only 360 AI recruitment agency specializing in AU construction. Save 75% time, reduce costs 60%, achieve 95% accuracy. No ATS needed.",
  keywords: "AI recruitment, construction hiring, Australian construction, recruitment agency, AI powered hiring, construction jobs",
  ...
  openGraph: {
    title: "StaffToday.AI - AI Recruitment Agency for Australian Construction",
    description: "Hand our AI recruiters a job description; they'll source, contact, & phone-screen candidates. Just like a human recruiter.",
    url: "https://stafftoday.ai/",
    siteName: "StaffToday.AI",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763457469875-b06ertlc.jpg",
  ...
  twitter: {
    ...
    title: "StaffToday.AI - AI Recruitment Agency for Australian Construction",
    description: "Save 75% time, reduce costs 60%, achieve 95% accuracy in candidate matching",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763457469875-b06ertlc.jpg"]
  },
  robots: {
    index: true,
    follow: true
